...
export const ANIMATIONS = {
  ...
  // ─── Sniper weapon animations ─────────────────────────────────────────────
  // Replicated from the rifle set (idle/walk/walk_shoot/run/jump/single-fire)
  // with the same arm/forearm rotations so existing rifle tuning carries over.
  // Differences vs rifle: single-shot fire (sniper_fire) with longer
  // recovery, no full-auto variant.
  ...
  // Walk + fire (slow cadence — one shot per cycle, not full-rifle rate).
  sniper_walk_shoot: {
    name: 'Walk Shoot',
    duration: 0.72,
    loop: true,
    tracks: {
      torso: [
        { time: 0.00, y:  0, rotation:  0.10 },
        { time: 0.09, y: -3, rotation:  0.05 },
        { time: 0.14, y: -5, rotation:  0.14 },
        { time: 0.18, y: -6, rotation:  0.12 },
        { time: 0.36, y:  0, rotation:  0.10 },
        { time: 0.54, y: -6, rotation:  0.12 },
        { time: 0.72, y:  0, rotation:  0.10 },
      ...
      right_arm: [
        { time: 0.00, rotation:  1.35 },
        { time: 0.07, rotation:  1.33 },
        { time: 0.09, rotation:  1.23 },
        { time: 0.14, rotation:  1.36 },
        { time: 0.18, rotation:  1.32 },
        { time: 0.36, rotation:  1.35 },
        { time: 0.54, rotation:  1.32 },
        { time: 0.72, rotation:  1.35 },
      ],
      right_forearm: [
        { time: 0.00, rotation: -1.50 },
        { time: 0.07, rotation: -1.48 },
        { time: 0.09, rotation: -1.78 },
        { time: 0.14, rotation: -1.45 },
        { time: 0.18, rotation: -1.47 },
        { time: 0.36, rotation: -1.50 },
        { time: 0.54, rotation: -1.47 },
        { time: 0.72, rotation: -1.50 },
      ],
      right_hand: [
        { time: 0.00, rotation:  0.00 },
        { time: 0.09, rotation:  0.22 },
        { time: 0.18, rotation:  0.00 },
        { time: 0.72, rotation:  0.00 },
      ],
      left_arm: [
        { time: 0.00, rotation: -2.20 },
        { time: 0.09, rotation: -2.10 },
        { time: 0.14, rotation: -2.23 },
        { time: 0.18, rotation: -2.22 },
        { time: 0.36, rotation: -2.20 },
        { time: 0.54, rotation: -2.22 },
        { time: 0.72, rotation: -2.20 },
      ],
      left_forearm: [
        { time: 0.00, rotation:  0.10 },
        { time: 0.09, rotation: -0.05 },
        { time: 0.14, rotation:  0.10 },
        { time: 0.18, rotation:  0.08 },
        { time: 0.36, rotation:  0.10 },
        { time: 0.54, rotation:  0.08 },
        { time: 0.72, rotation:  0.10 },
  ...
  sniper_jump: {
    ...
    tracks: {
      ...
      right_arm:    [{ time: 0.0, rotation: 1.35 }, { time: 0.12, rotation: 1.40 }, { time: 0.35, rotation: 1.25 }, { time: 0.68, rotation: 1.42 }, { time: 0.9, rotation: 1.35 }],
      right_forearm:[{ time: 0.0, rotation:-1.50 }, { time: 0.35, rotation:-1.55 }, { time: 0.9, rotation:-1.50 }],
      right_hand:   [{ time: 0.0, rotation: 0.00 }, { time: 0.9, rotation: 0.00 }],
      left_arm:     [{ time: 0.0, rotation:-2.20 }, { time: 0.12, rotation:-2.15 }, { time: 0.35, rotation:-2.30 }, { time: 0.68, rotation:-2.15 }, { time: 0.9, rotation:-2.20 }],
      left_forearm: [{ time: 0.0, rotation: 0.10 }, { time: 0.35, rotation: 0.05 }, { time: 0.9, rotation: 0.10 }],
      left_hand:    [{ time: 0.0, rotation: 0.00 }, { time: 0.9, rotation: 0.00 }],
      left_leg:  [{ time: 0.0, rotation:-0.16 }, { time: 0.12, rotation:-0.45 }, { time: 0.35, rotation:-0.55 }, { time: 0.58, rotation: 0.00 }, { time: 0.68, rotation:-0.30 }, { time: 0.9, rotation:-0.16 }],
      right_leg: [{ time: 0.0, rotation: 0.16 }, { time: 0.12, rotation: 0.45 }, { time: 0.35, rotation: 0.55 }, { time: 0.58, rotation: 0.00 }, { time: 0.68, rotation: 0.30 }, { time: 0.9, rotation: 0.16 }],
      left_shin: [{ time: 0.0, rotation: 0.18 }, { time: 0.12, rotation: 0.65 }, { time: 0.35, rotation: 0.10 }, { time: 0.68, rotation: 0.55 }, { time: 0.9, rotation: 0.18 }],
  ...
  // Single-shot fire — replicates the rifle Shoot pose with a longer
  // recovery so it reads as a deliberate sniper shot.
  sniper_fire: {
    name: 'Fire',
    duration: 1.0,
    loop: false,
    tracks: {
      torso: [
        { time: 0.00, y:  0, rotation:  0.04 },
        { time: 0.03, y:  2, rotation: -0.05 },
        { time: 0.18, y: -1, rotation:  0.07 },
        { time: 0.50, y:  0, rotation:  0.04 },
        { time: 1.00, y:  0, rotation:  0.04 },
      ],
      lower_torso: [
        { time: 0.00, rotation:  0.00 },
        { time: 0.03, rotation: -0.07 },
        { time: 0.40, rotation:  0.00 },
        { time: 1.00, rotation:  0.00 },
      ],
      head: [
        { time: 0.00, rotation:  0.00 },
        { time: 0.05, rotation:  0.05 },
        { time: 0.40, rotation: -0.02 },
        { time: 1.00, rotation:  0.00 },
      ],
      right_arm: [
        { time: 0.00, rotation: 1.35 },
        { time: 0.03, rotation: 1.25 },
        { time: 0.25, rotation: 1.38 },
        { time: 1.00, rotation: 1.35 },
      ],
      right_forearm: [
        { time: 0.00, rotation: -1.50 },
        { time: 0.03, rotation: -1.80 },
        { time: 0.25, rotation: -1.45 },
        { time: 1.00, rotation: -1.50 },
      ],
      right_hand: [
        { time: 0.00, rotation:  0.00 },
        { time: 0.03, rotation:  0.25 },
        { time: 0.40, rotation:  0.00 },
        { time: 1.00, rotation:  0.00 },
      ],
      left_arm: [
        { time: 0.00, rotation: -2.20 },
        { time: 0.03, rotation: -2.10 },
        { time: 0.25, rotation: -2.23 },
        { time: 1.00, rotation: -2.20 },
      ],
      left_forearm: [
        { time: 0.00, rotation:  0.10 },
        { time: 0.03, rotation: -0.05 },
        { time: 0.40, rotation:  0.10 },
        { time: 1.00, rotation:  0.10 },
      ],
      left_hand:  [{ time: 0.00, rotation: 0.00 }, { time: 1.00, rotation: 0.00 }],
      left_leg:   [{ time: 0.0, rotation: -0.15 }, { time: 1.0, rotation: -0.15 }],
      left_shin:  [{ time: 0.0, rotation:  0.22 }, { time: 1.0, rotation:  0.22 }],
      left_foot:  [{ time: 0.0, rotation: -0.05 }, { time: 1.0, rotation: -0.05 }],
      right_leg:  [{ time: 0.0, rotation:  0.12 }, { time: 1.0, rotation:  0.12 }],
      right_shin: [{ time: 0.0, rotation:  0.25 }, { time: 1.0, rotation:  0.25 }],
      right_foot: [{ time: 0.0, rotation:  0.06 }, { time: 1.0, rotation:  0.06 }],
    },
  },
  ...
  // Walk + Fire — preserves every walk keyframe (t=0, 0.20, 0.40, 0.60, 0.80)
  // for seamless transitions; thump recoil fires between 0 and 0.20.
  grenade_launcher_walk_fire: {
    name: 'Walk Fire',
    duration: 0.80,
    loop: true,
    tracks: {
      // Thump kick: smaller, snappier than rocket_walk_fire's heavy shove.
      torso: [
        { time: 0.00, x:  0, y:  0, rotation:  0.13 },
        { time: 0.08, x: -5, y: -1, rotation:  0.09 },   // THUMP — sharp short push
        { time: 0.14, x: -2, y: -3, rotation:  0.16 },   // forward overshoot
        { time: 0.20, x:  0, y: -4, rotation:  0.14 },   // walk keyframe
        { time: 0.40, x:  0, y:  0, rotation:  0.13 },
        { time: 0.60, x:  0, y: -4, rotation:  0.14 },
        { time: 0.80, x:  0, y:  0, rotation:  0.13 },
      ],
      lower_torso: [
        { time: 0.00, rotation:  0.10 },
        { time: 0.08, rotation:  0.02 },
        { time: 0.20, rotation:  0.00 },
        { time: 0.40, rotation: -0.10 },
        { time: 0.60, rotation:  0.00 },
        { time: 0.80, rotation:  0.10 },
      ...
      head: [
        { time: 0.00, rotation: -0.04 },
        { time: 0.10, rotation:  0.02 },   // small jolt
        { time: 0.20, rotation: -0.05 },
        { time: 0.40, rotation: -0.06 },
        { time: 0.80, rotation: -0.04 },
      ],
      // Trigger arm — sharp upward muzzle tick on thump, settles quickly.
      right_arm: [
        { time: 0.00, rotation:  1.15 },
        { time: 0.08, rotation:  1.07 },   // muzzle climb
        { time: 0.14, rotation:  1.17 },   // overshoot
        { time: 0.20, rotation:  1.14 },
        { time: 0.40, rotation:  1.13 },
        { time: 0.60, rotation:  1.14 },
        { time: 0.80, rotation:  1.15 },
      ],
      right_forearm: [
        { time: 0.00, rotation: -1.45 },
        { time: 0.08, rotation: -1.55 },   // muzzle ticks up
        { time: 0.14, rotation: -1.41 },
        { time: 0.20, rotation: -1.44 },
        { time: 0.40, rotation: -1.43 },
        { time: 0.60, rotation: -1.44 },
        { time: 0.80, rotation: -1.45 },
      ],
      right_hand: [
        { time: 0.00, rotation:  0.00 },
        { time: 0.08, rotation:  0.10 },   // wrist snap
        { time: 0.20, rotation:  0.00 },
        { time: 0.80, rotation:  0.00 },
      ],
      // Support arm — small brace then settles.
      left_arm: [
        { time: 0.00, rotation: -2.05 },
        { time: 0.08, rotation: -2.01 },
        { time: 0.20, rotation: -2.06 },
        { time: 0.40, rotation: -2.07 },
        { time: 0.60, rotation: -2.06 },
        { time: 0.80, rotation: -2.05 },
      ],
      left_forearm: [
        { time: 0.00, rotation: -0.20 },
        { time: 0.08, rotation: -0.28 },
        { time: 0.20, rotation: -0.21 },
        { time: 0.40, rotation: -0.22 },
        { time: 0.60, rotation: -0.21 },
        { time: 0.80, rotation: -0.20 },
      ],
      left_hand:    [{ time: 0.00, rotation: 0.00 }, { time: 0.80, rotation: 0.00 }],
      // Legs verbatim from grenade_launcher_walk — fully interchangeable.
      left_leg:  [{ time: 0.00, rotation:-0.30 }, { time: 0.40, rotation: 0.30 }, { time: 0.80, rotation:-0.30 }],
      left_shin: [{ time: 0.00, rotation:0.14 }, { time: 0.20, rotation:0.12 }, { time: 0.40, rotation:0.20 }, { time: 0.60, rotation:0.55 }, { time: 0.80, rotation:0.14 }],
      left_foot: [{ time: 0.00, rotation:-0.15 }, { time: 0.20, rotation:0.00 }, { time: 0.40, rotation:0.20 }, { time: 0.60, rotation:-0.05 }, { time: 0.80, rotation:-0.15 }],
      right_leg:  [{ time: 0.00, rotation: 0.30 }, { time: 0.40, rotation:-0.30 }, { time: 0.80, rotation: 0.30 }],
...
export const WEAPON_ANIMATION_SETS = {
  ...
  sniper:  ['sniper_idle', 'sniper_walk', 'sniper_walk_shoot', 'sniper_run', 'sniper_jump', 'sniper_fire'],
